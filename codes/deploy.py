...
from codes.models.voc import Voc
from codes.models.decoder import LuongAttnDecoderRNN
from codes.models.encoder import EncoderRNN
from codes.models.greedysearch import GreedySearchDecoder
from codes.models.topksearch import TopKSearchDecoder


class Deploy(object):
    def __init__(self, filename="./scripted_chatbot.pth", k=6):
        # set the random seed
        self.SEED = 15
